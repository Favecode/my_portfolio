...
import { Code2, Target, Layers, Rocket } from "lucide-react";
  ...
  return (
    <div className="page fade-in">
      ...
      <div className="section">
        ...
        <h2 className="section-title">Full-Stack + WordPress Expertise</h2>
        <div className="philosophy-grid">
          <div className="card">
            <div className="card-title">Frontend Development</div>
            <div className="card-text">React.js, Next.js, TypeScript, Tailwind CSS, Framer Motion</div>
          </div>
          <div className="card">
            <div className="card-title">Backend Systems</div>
            <div className="card-text">Node.js, Python, Django, FastAPI, Flask, REST & GraphQL APIs</div>
          </div>
          <div className="card">
          ...
          <div className="card">
            ...
            <div className="card-text">AWS, Azure, GCP, Docker, CI/CD, Kubernetes, GitHub Actions</div>
          </div>
        </div>
      </div>
      ...
      <div className="cta-block">
        ...
        <p>Full-stack applications and WordPress systems designed for performance, scalability, and growth.</p>
