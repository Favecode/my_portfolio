...
export default function Home({ setPage }) {
  return (
    <div className="page fade-in">
      ...
      {/* ══════════════════════════════════
           INITIAL VIEWPORT FOLD (NEW)
           Hero + Stats are wrapped together so CSS (.home-fold)
           can guarantee they occupy the first viewport on load.
           Everything else below remains in normal document flow
           and is simply revealed by scrolling — no JS-based
           show/hide logic needed, so animations & functionality
           for those sections are 100% unchanged.
      ══════════════════════════════════ */}
