...
import { Code2, Server, Globe, Layers, GitBranch, Cloud, Database, Cpu, Zap, Lock, TrendingUp } from "lucide-react";
    ...
    <div className="page fade-in">
      ...
      <div className="section">
        <div className="why-hire-grid">
          ...
          <div>
          {[
  { Icon: Zap,         title: "Fast Delivery",          desc: "Most projects delivered in 1–3 weeks with regular progress updates." },
  { Icon: Globe,       title: "Remote-Ready",           desc: "Experienced working across time zones with international teams and clients." },
  { Icon: Lock,        title: "Clean, Secure Code",     desc: "Input validation and security best practices on every project." },
  { Icon: TrendingUp,  title: "Performance Obsessed",   desc: "Fast load times and optimised Core Web Vitals by default." },
].map((w) => (
