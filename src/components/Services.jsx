      ...
      <div className="services-hero">
        <div>
          ...
          <p className="hero-sub">
            ...
            experiences that scale with your growth. From web development
        ...
        <div className="code-block">
          ...
          <div>
            ...
            <span className="code-key">Node.js</span>
          </div>
          <div>
            <span className="code-acc">■</span>{" "}
            <span className="code-key">Python / Django / Flask</span>
          </div>
          <div>
            <span className="code-acc">■</span>{" "}
            <span className="code-key">RESTful APIs</span>
          </div>
          <div>
            <span className="code-acc">■</span>{" "}
          ...
          <div>
            <span className="code-acc">■</span>{" "}
            <span className="code-key">SQL</span>
          </div>
          <div>
        ...
        <div className="grid-2">
          ...
          <div className="card">
            ...
            <div style={{ marginTop: "1rem" }}>
              {["React.js", "JavaScript (ES6+)", "HTML5", "CSS3", "Tailwind CSS", "Bootstrap"].map(
                (t) => (
